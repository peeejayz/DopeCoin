...
// Confirmations: 3
// Difficulty: Retarget every 16 hours
// Reward: 120 coins per block, halved every 155,582 blocks
...
uint256 hashGenesisBlock("0x650bf3c563aa7024c6bcb61fb82b22e3f70edfeb5cb98f7ecbcc4096940deb4a");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 155582 blocks
    nSubsidy >>= (nHeight / 155582);

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan =  16 * 60 * 60; // dopecoin: 16 hours
static const int64 nTargetSpacing = 100; // dopecoin: 100 seconds blocks
...
// Dopecoin difficulty adjustment protocol switch
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2222097696813aad598380d1510818f5d571a795385976e1598326f843c59f80");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Dopecoin, freedom is not enough";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1391874467;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 748811;

        if (fTestNet)
        {
            block.nTime    = 1391859749;
            block.nNonce   = 309032;
        }
		...
		assert(block.hashMerkleRoot == uint256("0x2dae15fcc0733c28b589f5c745c2d289de0efacb4a427bfa107c8ceb322a3de2"));
